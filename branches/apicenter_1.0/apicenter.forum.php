<?php
    /**
     * @class  apicenterForum
     * @author NHN (developers@xpressengine.com)
     * @brief forum class of the apicenter module
     **/
    ...
    class apicenterForum {
        ...
        /**
         * @brief module: forum, api_type: list
         **/
		function _list($format = "xml"){
			...
			$document_list = $this->getForumDocumentList($module_srl);
        ...
        /**
         * @brief module: forum, api_type: view 
         **/
		function _view($format = "xml"){
			...
			$document_info = $this->getForumDocument($document_srl);
        ...
        /**
         * @brief module: forum, api_type: write
         **/
		function _write($format = "xml"){
			...
			if(!$obj->category_srl) { Context::set('error_message','Write document failed, the cat_id must be provided.'); return false; }
			...
			$document_info = $this->insertForumDocument($obj);
		...
		/**
         * @brief module: forum, api_type: modify
         **/
		function _modify($format = "xml"){
			...
			$document_info = $this->updateForumDocument($obj);
			Context::set('document_info', $document_info);
		...
		/**
         * @brief module: forum, api_type: delete
         **/
		function _delete($format = "xml"){
			...
			$document_info = $this->deleteForumDocument($obj);
			Context::set('document_info', $document_info);
		...
		/**
         * @brief module: forum, api_type: category
         **/
        ...
        /**
         * @brief get forum document list
         **/
		function getForumDocumentList($module_srl){
			$document_list = array();
        ...
        /**
         * @brief get forum document info
         **/
		function getForumDocument($document_srl){
			$oDocumentModel = &getModel('document');
        ...
        /**
         * @brief insert forum document
         **/
		function insertForumDocument($obj){
			
			if(!$obj->content || !$obj->module_srl || !$obj->category_srl) return false;
			...
			$document_info = $this->getForumDocument($args->document_srl);
        ...
        /**
         * @brief update forum document
         **/
		function updateForumDocument($obj){
       ...
       /**
         * @brief delete forum document
         **/
		function deleteForumDocument($obj){
			// get document item
			$documentInfo = Context::get('documentInfo');
